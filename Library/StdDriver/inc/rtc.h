...
/**
  ...
  * \hideinitializer
  */
#define RTC_CLEAR_ALARM_INT_FLAG()      (RTC->INTSTS_M = RTC_INTSTS_ALMIF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define RTC_CLEAR_TICK_INT_FLAG()       (RTC->INTSTS_M = RTC_INTSTS_TICKIF_Msk)
...
/**
  ...
  * \hideinitializer
  */
#define RTC_GET_ALARM_INT_FLAG()        ((RTC->INTSTS_M & RTC_INTSTS_ALMIF_Msk)? 1:0)
...
/**
  ...
  * \hideinitializer
  */
#define RTC_GET_TICK_INT_FLAG()         ((RTC->INTSTS_M & RTC_INTSTS_TICKIF_Msk)? 1:0)
