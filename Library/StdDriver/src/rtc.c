...
void RTC_GetAlarmDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    g_u32hiYear  = (RTC->CALM_M & RTC_CALM_TENYEAR_Msk) >> RTC_CALM_TENYEAR_Pos;
    g_u32loYear  = (RTC->CALM_M & RTC_CALM_YEAR_Msk) >> RTC_CALM_YEAR_Pos;
    g_u32hiMonth = (RTC->CALM_M & RTC_CALM_TENMON_Msk) >> RTC_CALM_TENMON_Pos;
    g_u32loMonth = (RTC->CALM_M & RTC_CALM_MON_Msk) >> RTC_CALM_MON_Pos;
    g_u32hiDay   = (RTC->CALM_M & RTC_CALM_TENDAY_Msk) >> RTC_CALM_TENDAY_Pos;
    g_u32loDay   = (RTC->CALM_M & RTC_CALM_DAY_Msk) >> RTC_CALM_DAY_Pos;

    /* Get alarm [Time digit] data */
    g_u32hiHour = (RTC->TALM_M & RTC_TALM_TENHR_Msk) >> RTC_TALM_TENHR_Pos;
    g_u32loHour = (RTC->TALM_M & RTC_TALM_HR_Msk) >> RTC_TALM_HR_Pos;
    g_u32hiMin  = (RTC->TALM_M & RTC_TALM_TENMIN_Msk) >> RTC_TALM_TENMIN_Pos;
    g_u32loMin  = (RTC->TALM_M & RTC_TALM_MIN_Msk) >> RTC_TALM_MIN_Pos;
    g_u32hiSec  = (RTC->TALM_M & RTC_TALM_TENSEC_Msk) >> RTC_TALM_TENSEC_Pos;
    g_u32loSec  = (RTC->TALM_M & RTC_TALM_SEC_Msk) >> RTC_TALM_SEC_Pos;
...
/**
  ...
  *                     u32Minute: Minute value, range between 0 ~ 59.                              \n
  *                     u32Second: Second value, range between 0 ~ 59.                              \n
  *                     u32TimeScale: The parameter is invalid in SubM.                             \n
  *                     u8AmPm: [RTC_AM / RTC_PM]                                                   \n
  *
  * @return     None
  *
...
void RTC_SetDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    {
        sPt->u32TimeScale = (RTC->CLKFMT & RTC_CLKFMT_24HEN_Msk);
...
void RTC_SetAlarmDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    else
    {
        ...
        RTC->CALM_M = (uint32_t)u32RegCALM;
        RTC->TALM_M = (uint32_t)u32RegTALM;
    }
}
...
/**
  ...
  * @param[in]  u32TimeMode     The parameter is invalid in SubM.
...
void RTC_SetTime(uint32_t u32Hour, uint32_t u32Minute, uint32_t u32Second, uint32_t u32TimeMode, uint32_t u32AmPm)
{
    ...
    u32TimeMode = (RTC->CLKFMT & RTC_CLOCK_24);
...
{
    RTC->CAMSK_M = ((uint32_t)u8IsTenYMsk << RTC_CAMSK_MTENYEAR_Pos) |
...
{
    RTC->TAMSK_M = ((uint32_t)u8IsTenHMsk << RTC_TAMSK_MTENHR_Pos) |
...
{
    RTC->TICK_M = (RTC->TICK_M & ~RTC_TICK_TICK_Msk) | u32TickSelection;
}
