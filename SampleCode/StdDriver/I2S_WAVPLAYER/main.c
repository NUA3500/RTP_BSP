...
{
    /*
     *  Configure Timer2, clock source from XTL_12M. Prescale 12
     */
    /* TIMER2 clock from HXT */
    ...
    TIMER2->INTSTS = 0x3;   /* write 1 to clear for safety */
    TIMER2->CMP = usec;
    TIMER2->CTL = (11 << TIMER_CTL_PSC_Pos) | TIMER_ONESHOT_MODE | TIMER_CTL_CNTEN_Msk;
