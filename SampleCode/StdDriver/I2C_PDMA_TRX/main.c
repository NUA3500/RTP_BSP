...
{
    /* Open PDMA Channel */
    PDMA_Open(PDMA, 1 << I2C2_PDMA_TX_CH); // Channel 0 for I2C0 TX
    PDMA_Open(PDMA, 1 << I2C1_PDMA_RX_CH); // Channel 1 for I2C1 RX
    PDMA_Open(PDMA, 1 << I2C2_PDMA_RX_CH); // Channel 2 for I2C0 RX
    PDMA_Open(PDMA, 1 << I2C1_PDMA_TX_CH); // Channel 3 for I2C1 TX
    // Select basic mode
    PDMA_SetTransferMode(PDMA, I2C2_PDMA_TX_CH, PDMA_I2C0_TX, 0, 0);
    PDMA_SetTransferMode(PDMA, I2C1_PDMA_RX_CH, PDMA_I2C1_RX, 0, 0);
    PDMA_SetTransferMode(PDMA, I2C2_PDMA_RX_CH, PDMA_I2C0_RX, 0, 0);
    ...
    PDMA_SetTransferAddr(PDMA,I2C2_PDMA_TX_CH, ((uint32_t) (&g_u8MasterTx_Buffer[0])), PDMA_SAR_INC, (uint32_t)(&(I2C2->DAT)), PDMA_DAR_FIX);
    PDMA_SetTransferAddr(PDMA,I2C1_PDMA_RX_CH, (uint32_t)(&(I2C1->DAT)), PDMA_SAR_FIX, ((uint32_t) (&g_u8SlaveRx_Buffer[0])), PDMA_DAR_INC);
    PDMA_SetTransferAddr(PDMA,I2C2_PDMA_RX_CH, (uint32_t)(&(I2C2->DAT)), PDMA_SAR_FIX, ((uint32_t) (&g_u8MasterRx_Buffer[0])), PDMA_DAR_INC);
    ...
    PDMA_EnableInt(PDMA, I2C2_PDMA_RX_CH, 0);
...
int32_t main (void)
{
    ...
    */
    ...
    printf("|                                                       |\n");
    printf("| I2C Master (I2C2) <---> I2C Slave(I2C1)               |\n");
    printf("+-------------------------------------------------------+\n");
